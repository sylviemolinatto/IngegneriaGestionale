...
public class ItunesDAO {
	...
	public List<Track> getVertici(Genre genre){
	...
	public List<Edge> getArchi(Genre genre){
		
		final String sql = "SELECT t1.TrackId as t1ID, t2.TrackId as t2ID, ABS(t1.Milliseconds-t2.Milliseconds)AS weight "
				+ "FROM track t1, track t2 "
				+ "WHERE t1.TrackId>t2.TrackID AND t1.MediaTypeId=t2.MediaTypeId and t1.GenreId=? AND t2.GenreId=t1.GenreId "
				+ "GROUP BY t1.TrackId,t2.TrackId "
				+ "ORDER BY ABS(t1.Milliseconds-t2.Milliseconds) desc";
		...
		try {
			...
			while (res.next()) {
				result.add(new Edge(res.getInt("t1ID"),res.getInt("t2ID"),res.getDouble("weight")));
