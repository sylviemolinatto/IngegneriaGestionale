...
public class YelpDao {
	...
	public List<Edge> getArchi(String city, Map<String,Business> idMap){
		...
		try {
			...
			while (res.next()) {
				...
				result.add(new Edge(b1,b2,weight));
	...
	public List<Business> getBusinessByAverageAndCity(String city, double avg){
