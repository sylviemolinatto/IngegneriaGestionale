...
public class EventsDao {
	...
	public List<String> getVertici(String categoriaReato, int mese){
	...
	public List<Edge> getArchi(String categoriaReato, int mese) {
		
		String sql = "SELECT e1.offense_type_id as o1, e2.offense_type_id as o2, COUNT(DISTINCT e1.neighborhood_id) as weight "
				+ "FROM EVENTS e1, EVENTS e2 "
				+ "WHERE e1.offense_category_id=? AND e2.offense_category_id=e1.offense_category_id AND "
				+ "MONTH(e1.reported_date)=? AND MONTH(e2.reported_date)=MONTH(e1.reported_date) AND e1.neighborhood_id=e2.neighborhood_id "
